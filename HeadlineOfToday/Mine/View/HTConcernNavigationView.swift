...
protocol HTConcernNavigationViewDelegate: class {
...
class HTConcernNavigationView: UIView, LoadNibProtocol {
    ...
    weak var delegate: HTConcernNavigationViewDelegate?
    /// 标题
