//
//  HTFollowDetailViewController.swift
//  HeadlineOfToday
//
...
class HTFollowDetailViewController: AnimatableModalViewController {
    ...
    override func viewDidLoad() {
        ...
        NetworkTool.loadOneFollowDetail(userId: userid) { (followDetail) in
            ...
            for toptab in followDetail.top_tab {
                let topTabVC = HTTopTabViewController()
    ...
    /// 头部
    fileprivate lazy var headerView: HTConcernHeaderView = {
        let headerView = HTConcernHeaderView.loadViewFromNib()
        return headerView
    }()
...
extension HTFollowDetailViewController: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let topTabVC = childViewControllers[indexPath.row] as! HTTopTabViewController
...
extension HTFollowDetailViewController {
...
extension HTFollowDetailViewController: HTConcernNavigationViewDelegate {
    /// 返回按钮点击
...
extension HTFollowDetailViewController: UIScrollViewDelegate {
