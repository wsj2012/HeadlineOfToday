...
class HTVideoDetailController: UIViewController {
    ...
    fileprivate lazy var relateTableView: UITableView = {
        ...
        tableView.register(UINib(nibName: String( describing: HTRelateVideoNewsCell.self), bundle: nil), forCellReuseIdentifier: String( describing: HTRelateVideoNewsCell.self))
    ...
    fileprivate lazy var commentTableView: UITableView = {
        ...
        tableView.delegate = self
        tableView.backgroundColor = UIColor.globalBackgroundColor()
        tableView.register(UINib(nibName: String( describing: HTNewsDetailImageCommentCell.self), bundle: nil), forCellReuseIdentifier: String( describing: HTNewsDetailImageCommentCell.self))
        tableView.separatorStyle = .none
        return tableView
    }()
    ...
    /// 相关新闻头部
    fileprivate lazy var relateHeaderView: HTRelateHeaderView = {
        let headerView = HTRelateHeaderView.loadViewFromNib()
        return headerView
    }()
}

extension HTVideoDetailController {
...
extension HTVideoDetailController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if tableView == relateTableView {
            let cell = tableView.dequeueReusableCell(withIdentifier: String(describing: HTRelateVideoNewsCell.self), for: indexPath) as! HTRelateVideoNewsCell
            cell.relateNews = relateNews[indexPath.row]
            return cell
        } else {
            let cell = tableView.dequeueReusableCell(withIdentifier: String( describing: HTNewsDetailImageCommentCell.self), for: indexPath) as! HTNewsDetailImageCommentCell
    ...
    // push
    fileprivate func setupPushViewController(cell: HTNewsDetailImageCommentCell) {
